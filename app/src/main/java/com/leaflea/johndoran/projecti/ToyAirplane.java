 ...
 */
public class ToyAirplane extends Vehicles {
    public int getPrice() {
        return price;
    }
    ...
    float g=0;
    public ToyAirplane(GL10 gl,float MotorX,float MotorY,float MotorZ,float xrot,float yrot,float zrot) {
    ...
    public void generateModel(){
        ...
        float cyl1XPos=wingSpan*0.5f;
        float supportCylRadius=1f*actualSize;
        ...
        short[] fullWingIndices=concatIndicesArrays(concatIndicesArrays(wingIndices, supportCylinderIndices),wingIndices );

        //wing cyl wing cyl


        float[] fullWingVertices=new float[wing.length*2+supportCylinderVertices.length];
        ...
        float rudderLength=.7f*actualSize;
        float rudderHeight=radius*5f*actualSize;
        float rudderWidth=clippedWidth*3f*actualSize;
        float rudderX=0;
        float rudderY=centreCyl[1];
        float rudderZ=centreCyl[2+3*(int)((float)nCylStacks*0.25f)];
        ...
        for(int c=0;c<centreCyl.length/3;c++){
            R=0.8f+(float)c/(float)(centreCyl.length/3)*0.2f;
            G=0.2f+(float)c/(float)(centreCyl.length/3)*0.1f;
            B=0.2f+(float)c/(float)(centreCyl.length/3)*0.1f;
        ...
        for(int c=(int)((float)nCylStacks*0.45f);c<(int)((float)nCylStacks*0.55f);c++){
            R=0f;
            G=0f;
            B=0f;

            int width=(int)(((float)nCylStacks*0.5f*1f)*((float)nCylStacks*0.1f)-Math.abs((int)((float)nCylStacks*0.5f)-c));
        ...
        G=0f;
        B=0f;
        for(int c=0;c<wing.length/3;c++){//flat wing
        ...
        for(int c=0;c<wing.length/3;c++){//wing
            ...
            colors[(centreCyl.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+0]=R;
            colors[(centreCyl.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+1]=G;
            colors[(centreCyl.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+2]=B;
            colors[(centreCyl.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+3]=1f;

            colors[(centreCyl.length+wing.length*1+supportCylinderVertices.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+0]=R;
            colors[(centreCyl.length+wing.length*1+supportCylinderVertices.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+1]=G;
            colors[(centreCyl.length+wing.length*1+supportCylinderVertices.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+2]=B;
            colors[(centreCyl.length+wing.length*1+supportCylinderVertices.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+3]=1f;
        ...
        G=0.875f;
        B=0.125f;
        for(int c=0;c<supportCylinderVertices.length/3;c++){//support cylinder


            colors[(centreCyl.length+wing.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+0]=R;
            colors[(centreCyl.length+wing.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+1]=G;
            colors[(centreCyl.length+wing.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+2]=B;
            colors[(centreCyl.length+wing.length+wing.length*2+supportCylinderVertices.length*1)/3*4+c*4+3]=1f;
        ...
        for(int c=0;c<rudderVerts.length/3;c++){        //Rudder




            colors[(centreCyl.length+(wing.length*2+supportCylinderVertices.length*1)*2)/3*4+c*4+0]=R-((float)c-(float)rudderVerts.length)/((float)rudderVerts.length)*R/1f;
            colors[(centreCyl.length+(wing.length*2+supportCylinderVertices.length*1)*2)/3*4+c*4+1]=G-((float)c-(float)rudderVerts.length)/((float)rudderVerts.length)*G/1f;
            colors[(centreCyl.length+(wing.length*2+supportCylinderVertices.length*1)*2)/3*4+c*4+2]=B-((float)c-(float)rudderVerts.length)/((float)rudderVerts.length)*B/1f;
            colors[(centreCyl.length+(wing.length*2+supportCylinderVertices.length*1)*2)/3*4+c*4+3]=1f;
