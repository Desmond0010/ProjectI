package com.leaflea.johndoran.projecti.util;
...
public class IabHelper {
    ...
    public boolean getmAsyncInProgress(){
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        Log.d(TAG, "startSetup in IabHelper");
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                logDebug("mService CONNECTED");

                if (mDisposed) return;
                logDebug("Billing service connected. " +Long.toString(System.nanoTime()));
...
*/
        ...
        logDebug("Before service intent ");
